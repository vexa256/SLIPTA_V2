...
<body class="antialiased bg-gray-50 text-gray-900 overflow-hidden" x-data="sliptaApp()" x-cloak>
    ...
    <div class="h-screen flex">
        ...
        <!-- Mobile Header -->
        <div
            class="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        ...
        <aside
            class="fixed lg:static inset-y-0 left-0 z-40 w-56 bg-white border-r border-gray-200 transform lg:transform-none transition-transform duration-300"
            ...
            <div class="h-full flex flex-col">
                ...
                <div class="flex-1 overflow-y-auto custom-scrollbar px-3 pb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-1">
                            <div x-show="userRole === 'system_admin' || userRole === 'project_coordinator'"
                                x-data="{ open: false }">
                                <button @click="open = !open"
                                    ...
                                    <i class="fas fa-chevron-right h-3 w-3 text-gray-400 transition-transform"
                                        :class="{ 'rotate-90': open }"></i>
                                </button>
                                <div x-show="open" x-collapse class="ml-6 space-y-1 mt-1">
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Users</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Roles</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Role
                                        Assignments</a>
                                </div>
                            </div>
                    ...
                    <div class="mb-6">
                        <h3 class="mb-2 px-3 text-xs font-medium text-gray-500 uppercase tracking-wider">SLIPTA
                            CATALOGUE</h3>
                        <div class="space-y-1">
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" x-collapse class="ml-6 space-y-1 mt-1">
                                    <a href="{{ route('slipta.sections.index') }}"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">SLIPTA
                                        Sections</a>
                                    <a href="{{ route('slipta.questions.index') }}"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Questions</a>
                                    {{-- <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Sub-questions</a>
                                    --}}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-6">
                        <h3 class="mb-2 px-3 text-xs font-medium text-gray-500 uppercase tracking-wider">AUDIT LIFECYCLE
                        </h3>
                        <div class="space-y-1">
                            <div x-data="{ open: false }">
                                <button @click="open = !open"
                                ...
                                <div x-show="open" x-collapse class="ml-6 space-y-1 mt-1">
                                    <a href="{{ route('users.index') }}"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">User
                                        settings</a>
                                    <a href="{{ route('audits.index') }}"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Manage
                                        Audits</a>


                                    <a href="{{ route('audits.team.index') }}"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">
                                        Audit Teams</a>

                                    <a href="{{ route('audits.linking.index') }}"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">
                                        Audit Linking</a>
                            ...
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" x-collapse class="ml-6 space-y-1 mt-1">
                                    <a href="{{ route('audits.select') }}"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Conduct
                                        Audit</a>
                                    {{-- <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Sub-question
                                        Responses</a> --}}
                                </div>
                            </div>
                            ...
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" x-collapse class="ml-6 space-y-1 mt-1">
                                    {{-- <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Findings
                                        Log</a> --}}
                                    ...
                                    <a href="{{ route('reports.index') }}"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100"> <i
                                            class="fa-solid fa-file-pdf mr-3 text-gray-400 text-lg"></i>
                                        SLIPTA Report</a>
                            ...
                            {{-- Minimal Blade-only logout link (uses built-in route('logout')) --}}
                            <a href="{{ route('logout') }}"
                    ...
                    {{-- <div class="mb-6">
                        <h3 class="mb-2 px-3 text-xs font-medium text-gray-500 uppercase tracking-wider">VIEWS & REPORTS
                        </h3>
                        <div class="space-y-1">
                            <a href="#"
                                class="flex items-center rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            ...
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" x-collapse class="ml-6 space-y-1 mt-1">
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Lead
                                        Auditor View</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Team
                                        Member View</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Observer
                                        View</a>
                                </div>
                            </div>
                            ...
                            <a href="#"
                                class="flex items-center rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                x-show="userRole === 'country_coordinator'">
                            ...
                            <a href="#"
                                class="flex items-center rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                x-show="userRole === 'system_admin' || userRole === 'project_coordinator'">
                            ...
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" x-collapse class="ml-6 space-y-1 mt-1">
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Audit
                                        Summary Report</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Section
                                        Scorecards</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Team
                                        Activity</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Export
                                        Center (PDF/CSV)</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-6" x-show="userRole === 'system_admin' || userRole === 'project_coordinator'">
                        <h3 class="mb-2 px-3 text-xs font-medium text-gray-500 uppercase tracking-wider">ADMINISTRATION
                        </h3>
                        <div class="space-y-1">
                            <a href="#"
                                class="flex items-center rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            ...
                            <div x-data="{ open: false }">
                                ...
                                <div x-show="open" x-collapse class="ml-6 space-y-1 mt-1">
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Active
                                        Sessions</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">System
                                        Settings</a>
                                    <a href="#"
                                        class="block rounded-md px-3 py-2 text-sm text-gray-600 hover:bg-gray-100">Global
                                        Counters</a>
                                </div>
                            </div>
                        </div>
        ...
        <div x-show="sidebarOpen" @click="sidebarOpen = false"
            class="fixed inset-0 bg-black bg-opacity-50 lg:hidden z-30 transition-opacity"></div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden" :class="{ 'pt-16 lg:pt-0': true }">
            ...
            <header class="hidden lg:flex bg-white border-b border-gray-200 px-6 py-4 items-center justify-between">
                ...
                {{-- <div class="flex items-center space-x-4">
                    <button
                        class="flex items-center space-x-2 px-3 py-2 border border-gray-300 rounded-md text-sm bg-white hover:bg-gray-50">
    ...
    {{-- Add this snippet before closing
</body> tag in layouts.app --}}
...
}" x-show="show" @keydown.escape.window="close()" x-cloak class="fixed inset-0 z-50 overflow-y-auto">

    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">

        <div x-show="show" @click="close()" x-transition:enter="ease-out duration-300"
        ...
        <div x-show="show" @click.away="close()" x-transition:enter="ease-out duration-300"
            ...
            <div class="relative">
                ...
                <div class="px-6 pt-8 pb-6">
                    <div class="flex items-start space-x-4">
                        <div class="flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center" :class="{
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-neutral-600 mt-1">
                                <span
                                    x-text="type === 'error' ? 'The following error was encountered:' : 'Your action completed successfully.'"></span>
                            </p>
                        </div>
                        ...
                        <div x-show="showDetails" x-collapse
                            ...
                            <ul class="space-y-2">
                                ...
                                <li class="flex items-start space-x-2 text-sm text-red-800">
                                    <span
                                        class="flex-shrink-0 w-5 h-5 rounded-full bg-red-200 text-red-700 text-xs flex items-center justify-center font-semibold mt-0.5">
                                        {{ $index + 1 }}
                                    </span>
                    ...
                    <div class="mt-4">
                        ...
                        <div x-show="showDetails" x-collapse
                            ...
                            <pre
                                class="text-xs text-green-400 font-mono whitespace-pre-wrap">{{ session('error') }}</pre>
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="px-6 py-4 bg-neutral-50 border-t border-neutral-200 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        @if(session('error'))
                        <button
                            @click="navigator.clipboard.writeText(message); $dispatch('notification', {message: 'Error copied to clipboard', type: 'info'})"
                        ...
                        <button @click="close()"
                            class="px-4 py-2 text-sm font-medium text-white rounded-xl transition-colors" :class="{
